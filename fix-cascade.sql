-- Eliminar función y todo lo que depende de ella
DROP FUNCTION IF EXISTS check_instructor_etapa(uuid, text) CASCADE;

-- Recrear la función con los parámetros correctos
...
-- Recrear las policies que dependían de ella
